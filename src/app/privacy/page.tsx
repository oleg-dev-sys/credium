...
// Статическая дата обновления (обновляйте при изменениях)
const LAST_UPDATED = '15 января 2026';

export const metadata: Metadata = {
  title: 'Политика конфиденциальности — Credium',
  description: 'Политика конфиденциальности сервиса Credium для подбора кредитных продуктов',
  robots: {
    index: false,  // ← Запрещаем индексацию
    follow: true,
  },
  openGraph: {
    title: 'Политика конфиденциальности — Credium',
    description: 'Политика конфиденциальности сервиса',
  },
};
