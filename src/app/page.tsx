...
export const metadata: Metadata = {
  ...
  description: 'Подберите выгодный кредит или займ онлайн за несколько минут. Сравнение банков и МФО, мгновенные займы на карту, калькулятор и прозрачные условия. Начать подбор бесплатно.',
